...
menu_cmd = ['pen menu', 'pen Menu', 'เปิดเมนู', 'เรียกเมนู', 'show function', 'Show function', 'Show Menu', 'show menu',
            'Show menu']
simq_ask = ['ho are you', 'hat do you do', 'ho is your boss', 'ho am i', 'ell me a joke', 'ell me some joke','โคลอี้ จ๋า','hloe','โคลอิ','โคอี้','โคลอี','โคลอี้จ๋า','ถามได้ตอบได้','ศราวุธ','งอะแหละ','โบ้ะ','โบ๊ะ','ตึ่งโป้ะ','ตึ่งโปะ','ตึ่งโป๊ะ','อมึงแหละ','ตึงโป','วดฟ','wtf','โนว','ถามอะไรตอบได้','ด่ามึงอ','นั่นแหละ']
simq_ans = ['I am Chloe The Secretary of Colonel',
            ...
            'Some Human in this world', 'Joke ? google it :)', 'Ahh Nope','จ๋า ?','^^','^^','^^','^^','จ๋าาาา','ได้','ไม่พบศราวุธในสารบบ','ตะลึ่งตึ่งโป้ะ','โพ่ง','โพ่ง','พ่าง','พ่าง','พ่าง','ตะลึงตึ่งโป้ะ','พ่าง','วดฟ+1','wtf+1','โนโน้โนโน้','ไมได้ แบร่','ตะลึงตึ่งโป๊ะ!','ตะลึงตึ่งโป๊ะ!']
...
isinsult = '1'
president = ['ท้อ','ท่อ','ทอ','ท๊อ','ท๋อ','ปธ','ประ','ป่ระ','ปร่ะ','ป่ร่ะ','ปะ','ป่ะ','ป้ะ','ป๊ะ','ป๋ะ','ปท','พรหม','พรม','สุร','นท์','ทร์','พุท','พุธ','รรม','วงศ','วงส','วงษ','เมด','เม่ด','ป.ธ','ป,ธ','ป.ท','ปท','ป,ท','โคล','โคโ','โคอ']
special = ['!','@','#','$','%','^','&','*','(',')','_','+','=','-','.',',','/','\\',' ']     
...
if status == 0:
    if 'ขอรหัสนศ' in message:
	    ...
	    if 'เมดี้' in message:
	      result =  'ไม่ให้ค่ะ'
	    status = 1
insult = ['ด่าอิ','ด่าแม่ง','ด่าไอ','ด่ามัน','ด่าอีก','ด่าาแม่ง','ด่ามันสิ','ด่ามันซิ','ด่าต่อไป','ด่าอย่าหยุด']

prefixinsult = ['ไอ้','อี','อิ','ไอ']
reinsult2 = ['อิผี','อิผี','อิผี','อิผี','อิผี','อิผี','อิดอก','อีบลิซซาร์ดไม่คว่ำถ้วย','อีบลิซซาร์ดไม่คว่ำถ้วย','อีบลิซซาร์ดไม่คว่ำถ้วย','อีบลิซซาร์ดไม่คว่ำถ้วย','อีบลิซซาร์ดไม่คว่ำถ้วย','ไอ้แหวกกอหญ้า','ไอ้บ้าห้าร้อยจำพวก','ไอ้ปลวกใต้หลังคา','ไอ้หน้าปลาจวด',
'ไอ้บ้องกัญชา','ไอ้ปลาไม่กินเบ็ด','ไอ้เห็ดสามสี','อิเห็ดต้มยำ',
